      ...
      <table id="tabel" class="table table-bordered" cellspacing="0" width="100%" style="font-size: 12px">
        ...
        <tbody>
          <?php do{ 
                            ...
                            ?>
          <tr> 
            <td> <h5><a href="detail_transaksi?faktur=<?php echo $faktur; ?>"><?php echo $row['kd_faktur']; ?></a></h5>
              <?php echo longDate($row['tgl']); ?> <br> </td>
            <?php
            ...
            <td> 
              ...
              <div class="media"> 
                ...
                <div class="media-body" data-id="<?php echo $row_penjualan['kd_produk']; ?>"> 
                  ...
                  <b><?php echo $row_penjualan['jml_beli']; ?> Barang</b> </div>
              </div>
