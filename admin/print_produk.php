    ...
    <body onLoad="window.print()">
    	...
    	<div class="container">
    		...
    		<header style="text-align: center">
                ...
                <h3>Laporan Data Produk Periode <?php echo longDate($awal)." - ".longDate($akhir); ?></h3>
            ...
            <table id="tabel" class="table table-bordered" cellspacing="0" width="100%" style="font-size: 12px">
                ...
                <?php do{ 
                    ...
                    $sql_terjual = $con->query("SELECT a.*, b.*, SUM(b.jml_beli) as jml_terjual FROM faktur as a, penjualan as b WHERE b.kd_produk='$kd_produk' AND a.konfirm = 'Sudah' AND b.kd_faktur=a.kd_faktur AND a.tgl BETWEEN '$awal1' AND '$akhir1' ");
                ...
                ?>
                    <tr data-id="<?php echo $kd_produk; ?>">
                        ...
                        <td width="auto" align="center"><?php echo $row['expired']; ?></td>
