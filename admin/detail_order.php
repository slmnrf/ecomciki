...
<html lang="en">
    ...
    <div class="col-lg-12"> 
      <div class="panel"> <header class="panel-heading"> Detail Order </header> 
        <div class="panel-body"> 
          <!-- Tombol tambah -->
          <a href="print_faktur_detail?kd_faktur=<?php echo $kd_faktur; ?>&&pelanggan=<?php echo $id ?>" target="_blank" class="btn btn-success btn-sm"><span class="fa fa-print"></span> 
          Cetak Faktur</a> <br>
          <br>
          ...
          <table class="table table-bordered" style="font-size: 12px">
            <thead>
              <tr> 
                <th colspan="5" style="text-align: left; font-weight: bold"> <h5 style="font-weight: bold">No. 
                    Faktur: <?php echo $kd_faktur; ?></h5>
