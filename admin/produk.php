				        ...
				        <div class="col-lg-12">
							<div class="panel">
				                ...
				                <div class="panel-body table-responsive">
				                	<!-- Tombol tambah -->
				                	<a href="produk_tambah" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span> Tambah</a>
				                	<a data-toggle="modal" href='#modal-id' class="btn btn-success btn-sm"><span class="fa fa-print"></span> Cetak</a>
				                	<br><br>
				                    ...
				                    <table id="tabel" class="table table-bordered table-striped" cellspacing="0" width="100%" style="font-size: 12px">
				                        ...
				                        ?>
				                            <tr data-id="<?php echo $kd_produk; ?>">
				                                ...
				                                <td width="auto" align="center"><?php echo $row['bahan']; ?></td>
