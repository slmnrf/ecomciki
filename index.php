...
$sql_produk_home = $con->query("SELECT * FROM produk WHERE stok > 0 ORDER BY kd_produk ASC");
$row_produk_home = $sql_produk_home->fetch(PDO::FETCH_LAZY);
$trow_produk_home = $sql_produk_home->rowCount();

$sql_produk_baru = $con->query("SELECT * FROM produk WHERE stok > 0 ORDER BY tgl_produk DESC");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="konten">
	  <?php echo "<h4><b>PRODUK TERBARU<b></h4><p>"; ?> 
      <div class="row"> 
	  <?php do{
