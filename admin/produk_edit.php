...
if ((isset($_POST["ftambah"])) && ($_POST["ftambah"] == "y")) {
    ...
    if (empty($trow_cek)) { // bila data tidak ada
    	...
    	if (!empty($foto)) {  // jika foto tidak kosong
        	...
        	$con->exec("UPDATE produk SET nama_produk='$nama_produk', kd_kategori='$kd_kategori', bahan='$bahan', warna='$warna', expired='$expired', berat='$berat', harga='$harga', stok='$stok', deskripsi='$deskripsi', foto='$pfoto', diskon='$diskon' WHERE kd_produk='$kd_produk' ");
		    ...
		    $con->exec("UPDATE produk SET nama_produk='$nama_produk', kd_kategori='$kd_kategori', bahan='$bahan', warna='$warna', expired='$expired', berat='$berat', harga='$harga', stok='$stok', deskripsi='$deskripsi', diskon='$diskon' WHERE kd_produk='$kd_produk' ");
		    // pesan berhasil
		    tampilPesan("Berhasil Disimpan!","Data yang anda inputkan berhasil disimpan!","success","produk");
    	}
				                            ...
				                            <div class="row" style="margin-top: 20px">
				                            	<div class="col-xs-6">
				                            		<div class="form-group">
				                                        <label>expired</label>
				                                        <div class="input-group col-xs-12">
				                                            <input type="text" class="form-control" name="expired" required autocomplete="off" value="<?php echo $row['expired']; ?>">
				                                            <span class="input-group-addon danger" style="display: none;"></span>
				                                        </div>
				                                    </div>
				                                    <div class="form-group">
				                                ...
				                                <div class="col-xs-6">
				                                	<div class="form-group">
				                                        <label>Diskon (%)</label>
				                                        <div class="input-group col-xs-12">
				                                            <input type="text" class="form-control" name="diskon" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" maxlength="3" value="<?php echo $row['diskon']; ?>">
				                                        </div>
				                                    </div>
				                                </div>
				                                <div class="col-xs-6">
