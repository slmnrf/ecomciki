...
if ((isset($_POST["fdaftar"])) && ($_POST["fdaftar"] == "y")) {
    ...
    if (!empty($trow_cari)) {
        ...
        //$email_pengirim = "gsbatang@gmail.com";
        //$pass_pengirim = "gsbatang123";
        ...
        //$mail->FromName = "Galery Sport Batang";
        //$mail->AddAddress($email,$name);
        //$mail->AddReplyTo($webmaster_email,"Galery Sport Batang");
        //$mail->WordWrap = 50; 
        //$mail->AddAttachment("module.txt"); // attachment
        //$mail->AddAttachment("new.jpg"); // attachment
        //$mail->IsHTML(true); 
        //$mail->Subject = "Verifikasi Email Galery Sport Batang";
        //$mail->Body = "<h4>Pendaftaran berhasil!</h4><p>Hi $nama_plg, pendaftaran anda di toko online Galery Sport Batang kami telah berhasil!</p><p>Tinggal selangkah lagi untuk menjadi member kami, silahkan klik link dibawah ini untuk menyelesaikan pendaftaran</p><p>http://localhost/gsb/verifikasi?user=$username&&kode=$kode</p>"; 
...
<html lang="en">
    ...
    <div class="col-md-12"> 
      <div class="login-header"> 
        ...
        <h3>Daftar Member</h3>
        <p>Sudah punya akun? Masuk <a href="login">di sini</a></p>
      </div>
