...
if ((isset($_POST["ftambah"])) && ($_POST["ftambah"] == "y")) {
    ...
    if (empty($trow_cek)) { // bila data tidak ada
    	...
    	if (!empty($foto)) {  // jika foto tidak kosong
        	...
        	$con->exec("INSERT INTO produk (kd_produk, nama_produk, kd_kategori, bahan, warna, expired, berat, harga, stok, deskripsi, foto, diskon) 
				    			VALUES (
				    			'".$kd_produk_baru."',
				    			'".$nama_produk."',
				    			'".$kd_kategori."',
		    ...
		    $con->exec("INSERT INTO produk (kd_produk, nama_produk, kd_kategori, bahan, warna, expired, berat, harga, stok, deskripsi, diskon) 
		    			VALUES (
		    			'".$kd_produk_baru."',
		    			'".$nama_produk."',
		    			'".$kd_kategori."',
				                            ...
				                            <div class="row" style="margin-top: 20px">
				                            	<div class="col-xs-6">
				                            		<div class="form-group">
				                                        <label>Expired</label>
				                                        <div class="input-group col-xs-12">
				                                            <input type="text" class="form-control" name="expired" required autocomplete="off">
				                                            <span class="input-group-addon danger" style="display: none;"></span>
				                                        </div>
				                                    </div>
				                                    <div class="form-group">
				                                ...
				                                <div class="col-xs-6">
				                                	<div class="form-group">
				                                        <label>Diskon (%)</label>
				                                        <div class="input-group col-xs-12">
				                                            <input type="text" class="form-control" name="diskon" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" maxlength="3">
				                                        </div>
				                                    </div>
				                                </div>
				                                <div class="col-xs-6">
