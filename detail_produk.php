        ...
        <form method="POST" >
          ...
          <div class="col-sm-5"> 
            ...
            <table width="100%" style="margin-top: 20px; font-size: 13px">
              <tr> 
                <td> <p>Bahan</p></td>
                <td> <p>: <?php echo $row_detail_p['bahan']; ?></p></td>
                <td> <p>expired</p></td>
                <td> <p>: <?php echo $row_detail_p['expired']; ?></p></td>
              </tr>
              <tr> 
                <td> <p>Warna</p></td>
                <td> <p>: <?php echo $row_detail_p['warna']; ?></p></td>
                <td> <p>Berat</p></td>
                <td> <p>: <?php echo berat($row_detail_p['berat']); ?></p></td>
              </tr>
              <tr> 
                <td> <p>Stok</p></td>
                <td> <p>: <?php echo $row_detail_p['stok']; ?></p></td>
              </tr>
            </table>
            <div class="form-horizontal row"> 
              <div class="form-group col-sm-8"> 
                ...
                <div class="col-sm-7"> 
                  <input id="jml_beli" type="text" name="jml_beli" value="1" class="text-center">
                </div>
            ...
            <hr>
            <?php echo $row_detail_p['deskripsi']; ?> </div>
          <!-- Harga
							================================================ -->
          <div class="col-sm-3"> 
